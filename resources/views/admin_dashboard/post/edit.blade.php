                ...
                <div class="col-xl-4">
                    ...
                    <div class="card radius-10 w-100">
                        <div class="card-body">
                            ...
                            <a class='btn btn-sm btn-primary' data-toggle="modal" data-target="">
                                Select File
                            </a>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card radius-10 w-100">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between mt-3 col-12">
                                ...
                                @if (isset($post->scheduled_post_date))
                                    {{'checked'}}
                                @endif
                                >
                            </div>
                            <div id="scheduled_date_content" class="col-12 mt-3">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group mb-3">
                                        <input class="result form-control" type="text" name="date_published" id="date-time" placeholder="Date Picker..." value="{{$post->scheduled_post_date}}">
...
<script>
    ...
    // scheduled date
    var checked = $("#cb_scheduled").is(':checked');
    if (checked) {
