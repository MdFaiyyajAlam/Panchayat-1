                ...
                <x-bootstrap.card>
                    ...
                    <hr>
                        ...
                        <table id="example" class="table table-hover table-sm" style="width:100%">
                            <thead>
                                <tr>
                                    <th><input type="checkbox" class="checkbox-table" id="checkall"></th>
                            ...
                            <tbody>
                                @foreach ($posts as $list)
                                    <tr>
                                        <td>
                                            <input type="checkbox" name="checkbox-table" class="checkbox" value="{{$list->id}}" id="checkItem">
                                        </td>
                                        ...
                                        <td class="border-end">
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex flex-column mx-2">
                                                    ...
                                                    <div class="d-flex">
                                                        <small class="bg-danger text-white me-1 px-2 radius-30">
                                                            {{$list->post_type}}
                                                        </small>
                                                        @if ($list->is_featured == 1)
                                                            <small class="bg-success text-white me-1 px-2 radius-30">
                                                                Featured
                                                            </small>
                                                        @endif
                                                    </div>
