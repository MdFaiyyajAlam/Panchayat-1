            ...
            <div class="col d-flex">
                <div class="card radius-10 w-100">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.navigation.update', $navigation->id)}}" method="POST" class="row fw-bold">
                            @csrf
                            {{-- menu name --}}
                            <div class="col-12 mt-3">
                                <label for="menu-order" class="form-label">Menu Name</label>
                                <input type="text" class="form-control" id="menu-order" value="{{ ucwords($navigation->category->name) }}">
                            </div>
                            {{-- menu order --}}
                            <div class="col-12 mt-3">
                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="POST" class="row fw-bold">
                            ...
                            <div class="col-12 mt-3">
                              ...
                              <input type="number" name="menu_limit" class="form-control" value="1" min="1">
                            </div>
                            <div class="col-12 mt-4 d-flex justify-content-end">
