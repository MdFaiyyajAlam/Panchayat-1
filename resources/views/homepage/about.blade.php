    ...
    <section id="about">
        <div class="container my-5">
            <div class="title px-4">
                <h1>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sint ipsa exercitationem nesciunt.    </h1>
            </div>
            <div class="about-image p-4">
                <img src="{{asset('assets_home\img\poster1.jpg')}}" alt="">
                <p class="small text-center text-muted mt-3">
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nemo sequi illo perspiciatis sit eaque nulla aspernatur beatae. Quisquam iure officia, impedit omnis nam id, earum eos, quaerat eveniet non dicta?
                </p>
            </div>
